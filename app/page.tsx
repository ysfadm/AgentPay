...
const whyStellar = [
  {
    icon: Zap,
    title: "Sub-cent fees",
    body: "Agent micro-payments are only viable when fees are ~$0.00001.",
  },

  {
    icon: Zap,
    title: "~5s finality",
    body: "Agents can't wait 12 blocks. Stellar settles before the toast fades.",
  },

  {
    icon: Fingerprint,
    title: "Native smart wallets",
    body: "Stellar accounts can embed passkey-style auth at the protocol level.",
  },

  {
    icon: Coins,
    title: "Native USDC",
    body: "A stable unit of account — a real economy, not a volatile token.",
  },
];
      ...
      <main>
        ...
        <section className="mx-auto flex min-h-[calc(100vh-5rem)] max-w-6xl flex-col justify-center px-6 py-16 lg:px-8 lg:py-20">
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            <div>
              <Badge className="mb-6 px-4 py-1.5 text-sm lg:text-base">
                Build on Stellar · Agentic Track
              </Badge>
              ...
              <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground sm:text-xl lg:text-2xl lg:leading-relaxed">
                You grant a spending limit once with Freighter — your agent
                discovers services and pays on Stellar autonomously, within that
                cap.
              </p>
                ...
                {flowSteps.map((step, index) => (
                  <div key={step.label}>
                    ...
                    {index < flowSteps.length - 1 && (
                      <div
                        className="flex justify-center py-1 text-2xl text-muted-foreground/60"
                        aria-hidden
                      >
                        ↓
                      </div>
        ...
        <section className="border-t border-border/60 bg-card/30 py-20 lg:py-28">
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-center text-lg text-muted-foreground sm:text-xl">
              Scoped wallets, on-chain limits, and real USDC — built for agents
              that spend on their own.
            </p>
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            ...
            <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8">
              {whyStellar.map((f) => (
                <div
                  key={f.title}
                  className="rounded-2xl border border-border bg-background/50 p-6 sm:p-7"
                >
        ...
        <section className="border-t border-border/60 bg-linear-to-r from-primary/10 via-emerald-500/5 to-accent/10 py-16 lg:py-20">
          <div className="mx-auto max-w-3xl px-6 text-center lg:px-8">
            <h2 className="text-3xl font-bold sm:text-4xl">Ready to try it?</h2>

            <p className="mt-4 text-lg text-muted-foreground sm:text-xl">
              Unlock the console with your PIN, connect Freighter, and let your
              agent pay within limits you set.
            </p>
